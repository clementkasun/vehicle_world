                                ...
                                <ul class="list-child">
                                    ...
                                    <li class="list-item">
                                        ...
                                        <a href="#profile-menu-offcanvas" area-label="User" class="btn btn--size-33-33 btn--center btn--round offcanvas-toggle offside-menu">
                                            <img class="img-fluid" height="33" width="33" src="assets2/images/header-top-user-img.jpg" alt="user image"></a>
                                    </li>
                                </ul>
                            </li>
                        </ul>
                ...
                <div class="profile-details-section section-gap-top-30">
                    <div class="profile-details-wrapper">
                        <div class="profile-details-top">
                            ...
                            <div class="right">
                                <button aria-label="Wishlist" class="btn btn--size-58-58 btn--font-size-22 btn--center btn--round btn--color-radical-red btn--bg-white btn--box-shadow"><i
                                class="icon icon-carce-heart"></i></button>
                            </div>
                        </div>
                            ...
                            <ul class="profile-user-list">
                                <li class="profile-list-item">
                                    <ul class="profile-single-list">
                                        ...
                                        <li class="list-item">
                                            <a href="profile-settings.html" class="profile-link"><span class="icon"><i
                                                class="icon icon-carce-user"></i></span>Account Setting</a>
                                        </li>
                                        <li class="list-item">
                                            <a href="checkout.html" class="profile-link"><span class="icon"><i
                                                class="icon icon-carce-briefcase"></i></span>Billing & Payment</a>
                                        </li>
                                        <li class="list-item">
                                            <a href="notification.html" class="profile-link"><span class="icon"><i
                                                class="icon icon-carce-bell"></i></span>Notification</a>
                                        </li>
                                    </ul>
                                </li>
                                ...
                                <li class="profile-list-item">
                                    <ul class="profile-single-list">
                                        <li class="list-item">
                                            <a href="login.html" class="profile-link"><span class="icon"><i
                            ...
                            <div class="swiper-wrapper">
                                ...
                                <div class="swiper-slide">
                                    <a href="shop.html" class="btn"><span class="icon"><img width="33" height="33"
												src="assets2/images/catagories/sneakers.png" alt="image"></span> Sneakers</a>
                                </div>
                                <div class="swiper-slide">
                                    <a href="shop.html" class="btn"><span class="icon"><img width="33" height="33"
												src="assets2/images/catagories/watch.png" alt="image"></span>Watch</a>
                                </div>
                                <div class="swiper-slide">
                                    <a href="shop.html" class="btn"><span class="icon"><img width="33" height="33"
												src="assets2/images/catagories/headphones.png" alt="image"></span>Gadget</a>
                                </div>
                                <div class="swiper-slide">
                                    <a href="shop.html" class="btn"><span class="icon"><img width="33" height="33"
												src="assets2/images/catagories/bagpack.png" alt="image"></span>Bagpack</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="catagories-wrapper-content">
                        ...
                        <div class="single-product-item product-item--style-1 product-item--bg-lime-green">
                            ...
                            <div class="content">
                                ...
                                <div class="content--right">
                                    <a href="wishlist.html" aria-label="Wishlist" class="btn btn--size-33-33 btn--center btn--round btn--color-pink-swan btn--bg-white btn--box-shadow"><i
                        ...
                        <div class="single-product-item product-item--style-1 product-item--bg-gold">
                            ...
                            <div class="content">
                                ...
                                <div class="content--right">
                                    <a href="wishlist.html" aria-label="Wishlist" class="btn btn--size-33-33 btn--center btn--round btn--color-radical-red btn--bg-white btn--box-shadow"><i
											class="icon icon-carce-heart"></i></a>
                                </div>
                            </div>
                        </div>
