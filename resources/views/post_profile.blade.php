                                ...
                                <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                                    ...
                                    <div class="carousel-inner">
                                        ...
                                        <div class="carousel-item active">
                                            <img class="d-block w-100 img-responsive" src="{{asset("/storage/".$post_data->main_image)}}" style="height: 550px" alt="First slide">
                                        </div>
                                        @endif
                                        @if($post_data->image_1 != null)
                                        <div class="carousel-item">
                                            <img class="d-block w-100 img-responsive" src="{{asset("/storage/".$post_data->image_1)}}" style="height: 550px" alt="Second slide">
                                        </div>
                                        @endif
                                        @if($post_data->image_2 != null)
                                        <div class="carousel-item">
                                            <img class="d-block w-100 img-responsive" src="{{asset("/storage/".$post_data->image_2)}}" style="height: 550px" alt="Third slide">
                                        </div>
                                        @endif
                                        @if($post_data->image_3 != null)
                                        <div class="carousel-item">
                                            <img class="d-block w-100 img-responsive" src="{{asset("/storage/".$post_data->image_3)}}" style="height: 550px" alt="Fourth slide">
                                        </div>
                                        @endif
                                        @if($post_data->image_4 != null)
                                        <div class="carousel-item">
                                        ...
                                        @if($post_data->image_5 != null)
                                        <div class="carousel-item">
                                            <img class="d-block w-100 img-responsive" src="{{asset("/storage/".$post_data->image_5)}}" style="height: 550px" alt="Sixth slide">
                                        </div>
                                        @endif
                                    </div>
