function save_category(obj, callBack) {
    ...
    var url = '';
    url = "/api/survey/category_element/add";
    //JAKE STR
...
function delete_category(id, callBack) {
    ...
    var url = '';
    url = "/api/survey/category_element/delete/id/" + id;
    //JAKE STR
...
function get_category(id, callBack) {
    var url = '';
    url = "/api/survey/category_elements/cat/" + id;
    //JAKE STR
...
//#Get rand combo
function get_rand_combo(id, callBack) {
    var url = '';
    if (!id) {
        id = 0;
    }
